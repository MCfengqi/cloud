...
┃ ┃ ┣ 📄 AdminListServlet.java # 管理员管理处理
┃ ┃ ┗ 📄 GameManageServlet.java # 游戏管理处理
┃ ┣ 📂 resources
┃ ┃ ┣ 📄 application.properties # Spring Boot 配置文件
┃ ┃ ┣ 📄 application.yml # Spring Boot YAML配置
┃ ┃ ┗ 📂 db
┃ ┃ ┗ 📄 init.sql # 数据库初始化脚本
┃ ┗ 📂 webapp
┃ ┣ 📂 css
...
┃ ┃ ┣ 📄 adminManage.js # 管理员管理脚本
┃ ┃ ┗ 📄 gameManage.js # 游戏管理脚本
┃ ┣ 📂 images # 图片资源目录
┃ ┃ ┗ 📄 default-game.png # 默认游戏图片
┃ ┣ 📂 WEB-INF
┃ ┃ ┗ 📄 web.xml # Web应用配置文件
┃ ┣ 📄 index.jsp # 系统首页
┃ ┣ 📄 login.jsp # 登录页面
